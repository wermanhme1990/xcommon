...
static LPCTSTR s_TimeDeltaNames [7] = 
	{
		_T("60"),
		_T("30"),
		_T("20"),
...
int CPropertyBar::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
	...
	CBCGPProp* pGroup1 = new CBCGPProp (_T("Work week"));
	{
	...
	CBCGPProp* pGroup2 = new CBCGPProp (_T("Day view"));
...
void CPropertyBar::Update ()
{
	...
	((CBCGPColorProp*) pProp)->SetColor (opt.m_clrBackground);
	...
	pProp = m_wndPropList.GetProperty (6)->GetSubItem (0);
