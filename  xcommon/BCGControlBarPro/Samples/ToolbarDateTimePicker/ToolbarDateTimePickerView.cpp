// ToolbarDateTimePickerView.cpp : implementation of the CToolbarDateTimePickerView class
//
...
static const CString strInfo = 
	"This sample illustrates how to use date/time picker integrated with toolbar control.\r\n\r\n"
