// CustomPages.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CCustomPagesApp, CWinApp)
	//{{AFX_MSG_MAP(CCustomPagesApp)
...
CCustomPagesApp::CCustomPagesApp()
{
