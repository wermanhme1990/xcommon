// PropSheetDemoDlg.cpp : implementation file
//
...
CPropSheetDemoDlg::CPropSheetDemoDlg(CWnd* pParent /*=NULL*/)
	: CBCGPDialog(CPropSheetDemoDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPropSheetDemoDlg)
	m_bHeader = FALSE;
	//}}AFX_DATA_INIT
...
void CPropSheetDemoDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	//{{AFX_DATA_MAP(CPropSheetDemoDlg)
	DDX_Check(pDX, IDC_HEADER, m_bHeader);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CPropSheetDemoDlg, CBCGPDialog)
	//{{AFX_MSG_MAP(CPropSheetDemoDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
void CPropSheetDemoDlg::OnPropSheet1() 
{
	...
	CMyPropertySheet propSheet (CBCGPPropertySheet::PropSheetLook_Tabs);
...
void CPropSheetDemoDlg::OnPropSheet2() 
{
	...
	CMyPropertySheet propSheet (CBCGPPropertySheet::PropSheetLook_OutlookBar,
		IDB_ICONS_LARGE, 32);
...
void CPropSheetDemoDlg::OnPropSheet3() 
{
	...
	CMyPropertySheet propSheet (CBCGPPropertySheet::PropSheetLook_Tree,
		IDB_TREE_ICONS, 16);
...
void CPropSheetDemoDlg::OnPropSheet4() 
{
	...
	CMyPropertySheet propSheet (CBCGPPropertySheet::PropSheetLook_OneNoteTabs,
		IDB_ICONS_SMALL, 16);
...
void CPropSheetDemoDlg::OnPropSheet5() 
{
	...
	CMyPropertySheet propSheet (CBCGPPropertySheet::PropSheetLook_List);
