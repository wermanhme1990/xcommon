...
class CTasksPaneHistoryButton : public CBCGPToolbarMenuButton
{
	friend class CBCGPTasksPane;
...
IMPLEMENT_SERIAL(CTasksPaneHistoryButton, CBCGPToolbarMenuButton, 1)
...
BEGIN_MESSAGE_MAP(CTasksPaneToolBar, CBCGPToolBar)
...
//********************************************************************************
LRESULT CBCGPTasksPane::OnGetObject (WPARAM wParam, LPARAM lParam)
{ 	
...
void CBCGPTasksPane::NotifyAccessibility (int nGroupNumber, int nTaskNumber)
{
	...
	if (m_pAccTaskInfo == NULL)
	{
		m_pAccTaskInfo = new BCGPACC_TASKINFO;
	}
