...
[!endif]
[!if TOOLBAR_CUSTOMIZATION || CONTAINER || MINI_SERVER || FULL_SERVER || CONTAINER_SERVER || AUTOMATION || OLEDB || ACTIVEX_CONTROLS || ACCESSIBILITY]
...
[!if  APP_TYPE_MDI]
	CBCGPMDIFrameWnd* pFrame = new [!output MAIN_FRAME_CLASS];
[!else]
[!if !DOCVIEW]
...
[!if APP_TYPE_MDI]
	GetMouseManager()->AddView (IDR_[!output SAFE_DOC_TYPE_NAME]TYPE, _T("My view"), IDR_[!output SAFE_DOC_TYPE_NAME]TYPE);
[!else]
