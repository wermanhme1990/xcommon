...
void $$DOC_CLASS$$::SetPathName(LPCTSTR lpszPathName, BOOL bAddToMRU) 
{
	$$DOC_BASE_CLASS$$::SetPathName(lpszPathName, bAddToMRU);

	(($$FRAME_CLASS$$*) AfxGetMainWnd ())->UpdateMRUFilesList ();
}
$$ENDIF
$$IF(CRichEditView)
