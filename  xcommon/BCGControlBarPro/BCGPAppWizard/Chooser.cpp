...
CDialogChooser::CDialogChooser()
{
	...
	m_pDlgs[9] = new CCustom2Dlg;
	m_pDlgs[10] = new CCustom3Dlg;
	m_pDlgs[11] = new CCustom4Dlg;
...
static int nDocTrack[] = {0, 1, 2, 3, 4, 5, 6, 8, 9, 10, 11};
static int nDlgTrack[] = {0, 1, 7, 5, 6};
static int* pnTrack[] = {nDocTrack, nDlgTrack};
static int nLast[] = {10, 4};
...
CAppWizStepDlg* CDialogChooser::Next(CAppWizStepDlg* pDlg)
{
	...
	{
		CString strTemp;
		m_nTrack = BCGCBProAppWizardaw.m_Dictionary.Lookup(_T("PROJTYPE_DLG"), strTemp) ? 1 : 0;
