...
//===========================================================================
// Summary:
//     CXRegistryManager is a stand alone registry management class. You
//     can use it to read and write values from your system's registry or an
//     .INI file. Use CXRegistryManager to read and write string, integer,
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CXRegistryManager object
	// Parameters:
  ...
  CXRegistryManager(LPCTSTR);
	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXRegistryManager object, handles cleanup and deallocation
	//-----------------------------------------------------------------------
...
public:
	CXString m_strINIFileName;  // Name of an .INI file for registry settings.
public:
	//-----------------------------------------------------------------------
	// Summary:
	...
	// Returns:
	//     A reference to the CXString object that contains the INI file path.
	//-----------------------------------------------------------------------
	CXString& GetINIFileName();
	//-----------------------------------------------------------------------
	// Summary:
	...
	// <code>
	// void CXTDockWindow::LoadBarSize(CXString strSection)
	// {
	...
	// -----------------------------------------------------------------------------
	// Summary:
	//     Call this function to fill a CMap (CXString to DWORD) with the
	...
	//                    subsection names.
	//     arrayNames -   A reference to a CXStringArray which, if not NULL, will
	//                    contain an array of names in the order they were read from
	//                    the registry.
	// Remarks:
	//     The function also takes a pointer to a CXStringArray because CMap
	//     is a sorted container; therefore, it is not possible to get the
	//     items in the order they appeared from it.
	//
	//     Pass NULL for the CXStringArray* if you don't want to use it, and
	...
	//     values present.
	// -----------------------------------------------------------------------------
	int EnumValues(LPCTSTR lpszSection, CMap<CXString, LPCTSTR, DWORD, DWORD&>*  mapItems, 
    vector<CXString>* arrayNames);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this function to fill a CXStringArray with the names of keys below
	...
	//     CXStringArray::GetSize will give the same result if needed, assuming
	...
	//     lpszSection - Points to a null-terminated string that specifies the section
	//                   containing the entry.
	//     arrayKeys   - A reference to a CXStringArray, which will contain the keys in the
	...
	// Returns:
	//    Returns a CXString object that contains the error message that describes
