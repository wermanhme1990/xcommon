...
IMPLEMENT_DYNCREATE($$CHILD_FRAME_CLASS$$, CBCGPMDIChildWnd)

BEGIN_MESSAGE_MAP($$CHILD_FRAME_CLASS$$, CBCGPMDIChildWnd)
...
$$IF(MDI_TABS || CHILD_FRAME_MAXIMIZED || CHILD_FRAME_MINIMIZED)
...
$$ENDIF //VERBOSE
$$IF(CHILD_FRAME_MAXIMIZED || MDI_TABS)
...
{
	CBCGPMDIChildWnd::OnSetFocus(pOldWnd);
...
BOOL $$CHILD_FRAME_CLASS$$::OnCmdMsg(UINT nID, int nCode, void* pExtra, AFX_CMDHANDLERINFO* pHandlerInfo) 
{
	...
	return CBCGPMDIChildWnd::OnCmdMsg(nID, nCode, pExtra, pHandlerInfo);
}
