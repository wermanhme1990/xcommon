...
$$IF(!CHtmlView)
void $$VIEW_CLASS$$::OnFilePrintPreview() 
{
...
void $$VIEW_CLASS$$::OnLButtonDblClk(UINT nFlags, CPoint point) 
{
$$IF(PROJTYPE_MDI)
	theApp.OnViewDoubleClick (this, IDR_$$DOC$$TYPE);
$$ELSE
...
void $$VIEW_CLASS$$::OnContextMenu(CWnd*, CPoint point)
{
