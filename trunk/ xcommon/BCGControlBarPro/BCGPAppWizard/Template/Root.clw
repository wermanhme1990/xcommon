...
Class9=CAboutDlg
$$IF(WORKSPACEBAR)
Class10=$$WORKSPACEBAR_CLASS$$
Class11=$$WORKSPACEBAR_CLASS2$$
$$ENDIF //WORKSPACEBAR
$$IF(OUTPUTBAR)
Class12=$$OUTPUTBAR_CLASS$$
$$ENDIF //OUTPUTBAR
...
$$IF(WORKSPACEBAR)
[CLS:$$WORKSPACEBAR_CLASS$$]
Type=0
HeaderFile=$$workspace_hfile$$.h
ImplementationFile=$$workspace_ifile$$.cpp
Filter=W

[CLS:$$WORKSPACEBAR_CLASS2$$]
Type=0
HeaderFile=$$workspace2_hfile$$.h
ImplementationFile=$$workspace2_ifile$$.cpp
Filter=W
$$ENDIF //WORKSPACEBAR
...
[CLS:$$OUTPUTBAR_CLASS$$]
Type=0
HeaderFile=$$outputbar_hfile$$.h
ImplementationFile=$$outputbar_ifile$$.cpp
Filter=W
$$ENDIF //OUTPUTBAR
