// ClassViewBar1.cpp: implementation of the CClassViewBar class.
//
//////////////////////////////////////////////////////////////////////
...
void CClassViewBar::AdjustLayout ()
{
	...
	m_wndClassView.SetWindowPos (NULL, rectClient.left + 1, rectClient.top + cyTlb + 1,
...
void CClassViewBar::OnChangeVisualStyle ()
{
	...
	UINT uiBmpId = theApp.m_bHiColorIcons ? 
		IDB_CLASS_VIEW_24 : IDB_CLASS_VIEW;
	...
	m_wndToolBar.LoadBitmap (theApp.m_bHiColorIcons ? 
		IDB_SORT24 : IDR_SORT, 0, 0, TRUE /* Locked */);
}
