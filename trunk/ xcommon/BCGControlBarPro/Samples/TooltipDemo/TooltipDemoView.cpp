// TooltipDemoView.cpp : implementation of the CTooltipDemoView class
//
...
{
	//{{AFX_DATA_INIT(CTooltipDemoView)
	m_nTTType = 0;
	m_bBoldLabel = FALSE;
...
void CTooltipDemoView::OnApplyParams() 
{
	...
	if (m_nTTType == 1)	// Baloon tooltip
	{
		CBCGPToolTipParams paramsBalloon;
		paramsBalloon.m_bBallonTooltip = TRUE;
