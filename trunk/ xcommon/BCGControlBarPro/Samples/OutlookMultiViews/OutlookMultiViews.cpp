// OutlookMultiViews.cpp : Defines the class behaviors for the application.
//
//
...
BEGIN_MESSAGE_MAP(COutlookMultiViewsApp, CWinApp)
	//{{AFX_MSG_MAP(COutlookMultiViewsApp)
...
COutlookMultiViewsApp::COutlookMultiViewsApp() :
