...
public:
	...
	enum BCGP_PLANNER_HITTEST
	{
		...
		BCGP_PLANNER_HITTEST_HEADER             =  2, // day view or month view header area
		BCGP_PLANNER_HITTEST_HEADER_ALLDAY      =  3, // day view all day header area
		BCGP_PLANNER_HITTEST_CLIENT             =  4, // client area
		BCGP_PLANNER_HITTEST_DAY_CAPTION        =  5, // caption of the day in week and month views
		BCGP_PLANNER_HITTEST_ICON_UP            =  6, // up icons
		BCGP_PLANNER_HITTEST_ICON_DOWN          =  7, // down icons
		// this is appointment hit tests. include only new appointments enums
		BCGP_PLANNER_HITTEST_APPOINTMENT        =  8, // appointment area
		BCGP_PLANNER_HITTEST_APPOINTMENT_MOVE   =  9, // appointment move area (left side)
		BCGP_PLANNER_HITTEST_APPOINTMENT_TOP    = 10, // day view appointment top area (top side)
		BCGP_PLANNER_HITTEST_APPOINTMENT_BOTTOM = 11, // day view appointment bottom area (bottom side)
		BCGP_PLANNER_HITTEST_APPOINTMENT_LEFT   = 12, // day view appointment left area (left side)
		BCGP_PLANNER_HITTEST_APPOINTMENT_RIGHT  = 13, // day view appointment right area (right side)
	...
	enum BCGP_PLANNER_TIME_DELTA
	{
		...
		//BCGP_PLANNER_TIME_DELTA_4     = 1,
		//BCGP_PLANNER_TIME_DELTA_3     = 1,
		//BCGP_PLANNER_TIME_DELTA_2     = 1,
		//BCGP_PLANNER_TIME_DELTA_1     = 1
		BCGP_PLANNER_TIME_DELTA_LAST = BCGP_PLANNER_TIME_DELTA_5
	};
