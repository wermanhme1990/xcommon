...
//**********************************************************************************
LRESULT CBCGPMenuBar::OnGetObject (WPARAM wParam, LPARAM lParam)
{ 	
	...
	if (pWndMain != NULL)
	{
		...
		accData.m_objData = (void*)GetMenu ();
		accData.m_pWnd = this;
...
//**********************************************************************************
LRESULT CBCGPMenuBar::OnAccHitTest (WPARAM /*wParam*/, LPARAM lParam)
{
