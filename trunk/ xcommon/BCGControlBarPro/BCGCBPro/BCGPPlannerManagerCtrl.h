...
public:
	...
	void SetStorageRTC (CRuntimeClass* pStorageClass = NULL);
	void SetClockIconsRTC (CRuntimeClass* pClockIconsClass = NULL);
...
public:
	...
	enum BCGP_PLANNER_TYPE
	{
		...
		BCGP_PLANNER_TYPE_LAST      = BCGP_PLANNER_TYPE_MONTH
	};
