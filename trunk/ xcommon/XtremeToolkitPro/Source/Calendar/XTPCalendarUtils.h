...
public:
	...
	static CString AFX_CDECL GetDateFormat(CONST COleDateTime& dtDate, LPCTSTR lpFormat); // <COMBINE CXTPCalendarUtils::GetDateFormat@CONST SYSTEMTIME*@LPCTSTR>
	...
	static CString AFX_CDECL GetTimeFormat(CONST COleDateTime& dtTime, LPCTSTR lpFormat);   // <COMBINE CXTPCalendarUtils::GetTimeFormat@CONST SYSTEMTIME*@LPCTSTR>
	static CString AFX_CDECL GetTimeFormat(int nHour, int nMinutes, LPCTSTR lpFormat);      // <COMBINE CXTPCalendarUtils::GetTimeFormat@CONST SYSTEMTIME*@LPCTSTR>
	...
	static COleDateTime AFX_CDECL RetriveEventEndDate(const COleDateTime& dtStart, const COleDateTime& dtEnd); //<COMBINE CXTPCalendarUtils::RetriveEventEndDate@const CXTPCalendarEvent*>
