...
public:
	...
	virtual void AdjustLayout2(CDC* pDC, const CRect& rcEventMax, int nEventPlaceNumber) = 0; // <COMBINE CXTPCalendarViewEvent::AdjustLayout@CDC*@const CRect&@int>
	...
	virtual CString GetItemTextStartTime(); //<COMBINE GetItemTextSubject>
	virtual CString GetItemTextEndTime();   //<COMBINE GetItemTextSubject>
	virtual CString GetItemText(DWORD dwItemFlag, LPCTSTR pcszDefaultText = NULL); //<COMBINE GetItemTextSubject>
