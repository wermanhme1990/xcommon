...
void CXTPTopLevelWndMsgNotifier::_ProcessTimeZone()
{
...
BOOL CXTPTopLevelWndMsgNotifier::IsTimeZoneEqual(const TIME_ZONE_INFORMATION& rTzi1, const TIME_ZONE_INFORMATION& rTzi2) const
{
