...
public:
	...
	//     functionality for the control.
	//     Enabling this functionality allows a control to process customized
	//     special property xtpMarkupTemplate which could be set for each event.
	//     If this property exists and contains text with Markup information,
	//     it will be drawn inside the Event rectangle (instead of Subject and Body).
	// Parameters:
	//     bEnable : A BOOL. Specifies whether Markup functionality
	//               should be enabled (TRUE) or disabled (FALSE).
	// See Also:
	//     IsMarkupEnabled
	//     CXTPCalendarViewEvent::GetMarkupText()
