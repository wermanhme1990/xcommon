...
protected:
	...
	BOOL    m_bShowCaptionBar;  // Store Office 2007 theme Calendar Caption Bar state.

private:
	CXTPCalendarCaptionBarControl m_wndCalendarCaptionBar; // Child Calendar Caption Bar window
